...
Original file is located at
    https://colab.research.google.com/drive/1pRD2UnQ_JR27WKJ-a_nANGz7dShuy5PA
...
plt.plot(x_values, 0.1875*x_values**2 - 1.125*x_values + 3.45645093981337, linestyle = '-', label = 'Decision Boundary', color = 'green')
